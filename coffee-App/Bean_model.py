...
CREATE_BEANS_TABLE = "CREATE TABLE IF NOT EXISTS beans(id INTEGER , name TEXT PRIMARY KEY,method TEXT,rating INTEGER);"
...
def best_preparation_for_bean(connection, name):
    with connection:
